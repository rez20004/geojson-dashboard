var config = {
  geojson: "http://od.govmu.org/dkan/sites/default/files/trees_4.geojson",
...
// Basemap Layers
var mapboxOSM = L.tileLayer("https://{s}.tiles.mapbox.com/v4/mapbox.streets/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoicmV6MjAwMDQiLCJhIjoiY2o0ejl4bXNuMXRsbTMzcW5tMjl4eDg5NSJ9.VFRaotbDYG_pwk-I1j3BEQ", {
  maxZoom: 19,
  subdomains: ["a", "b", "c", "d"],
  attribution: 'Basemap <a href="https://www.mapbox.com/about/maps/" target="_blank">© Mapbox © OpenStreetMap</a>'
});

var mapboxSat = L.tileLayer("https://{s}.tiles.mapbox.com/v4/mapbox.streets-satellite/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoicmV6MjAwMDQiLCJhIjoiY2o0ejl4bXNuMXRsbTMzcW5tMjl4eDg5NSJ9.VFRaotbDYG_pwk-I1j3BEQ", {
  maxZoom: 19,
  subdomains: ["a", "b", "c", "d"],
  attribution: 'Basemap <a href="https://www.mapbox.com/about/maps/" target="_blank">© Mapbox © OpenStreetMap</a>'
});
